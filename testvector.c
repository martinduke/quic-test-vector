...
const unsigned char v2_cli_inhdr[] = {
    0xd3, 0x70, 0x9a, 0x50, 0xc4, 0x08, 0x83, 0x94,
    0xc8, 0xf0, 0x3e, 0x51, 0x57, 0x08, 0x00, 0x00,
    0x44, 0x9e, 0x00, 0x00, 0x00, 0x02,
};
...
const unsigned char v2_srv_inhdr[] = {
    0xd1, 0x70, 0x9a, 0x50, 0xc4, 0x00, 0x08, 0xf0,
    0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5, 0x00,
    0x40, 0x75, 0x00, 0x01, 
};
...
"~~~\n"
"\n"
"The protected packet is the smallest possible packet size of %d", short_len + tag_len); printf(" bytes.\n"
"\n"
"~~~\n"
